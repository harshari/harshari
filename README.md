...
- Stoked that (my first paper) our paper [SWAP: A Server-scale Communication-aware Chiplet-based Manycore PIM Accelerator](https://ieeexplore.ieee.org/document/9852792) is the BEST paper candidate at ESWEEK 2022 (TCAD Journal)! All thanks to my collaborators Prof. [Partha](https://eecs.wsu.edu/~pande/), [Jana](https://eecs.wsu.edu/~jana/), [Sumit Mandal](https://sumitkmandal.ece.wisc.edu/), and [Umit Ogras](https://directory.engr.wisc.edu/ece/Faculty/Ogras_/) 😃. 
